 ...
 */
/*
 *	cs_bsearch -- generic binary search, like qsort.
 *
 **********************************************************************
 * HISTORY
 * $Log:	cs_bsearch.c,v $
 * Revision 2.2  92/05/18  16:38:24  neek
 * 	Changed bsearch() to cs_bsearch so as not to
 * 	trick users who think this is the ansi version.
 * 	(Arguments are rearranged).
 * 	[92/05/18            neek]
 * 
...
/* cs_bsearch does a binary search on the array.  It returns either the index
...
int cs_bsearch (base, nel, width, key, compar)
