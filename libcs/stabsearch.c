 ...
 * HISTORY
 * $Log:	stabsearch.c,v $
 * Revision 1.3  91/07/02  17:34:23  neek
 * 	never allow 'maxscore' to be 0, since we divide by it.
 * 	It is derived from the length of a string, and it is 
 * 	possible for this to be the NULL string.
 * 	[91/07/02            neek]
 * 
