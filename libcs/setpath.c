 ...
 * HISTORY
 * $Log:	setpath.c,v $
 * Revision 1.5  92/03/24  14:09:50  mja
 * 	For gcc: forward declarations:
 * 		static int initpaths(), savepaths(), rcmd(), icmd(), iacmd(), ibcmd(), incmd();
 * 		static int insert(), dcmd(), delete(), ccmd(), cncmd(), change(), locate();
 * 		static int freepaths(), dncmd();
 * 	[91/11/26            rvb]
 * 
